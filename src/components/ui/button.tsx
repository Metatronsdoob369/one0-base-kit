...
export interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'default' | 'destructive' | 'outline' | 'secondary' | 'ghost' | 'link' | 'luminescent' | 'frosted' | 'bioluminescent';
  size?: 'default' | 'sm' | 'lg' | 'icon';
  playSound?: boolean; // New prop to control sound
}

const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'default', size = 'default', playSound = true, onClick, ...props }, ref) => {
