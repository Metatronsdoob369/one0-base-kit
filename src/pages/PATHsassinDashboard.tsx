...
const iconSize = 62;
const SelfIcon = (
  <svg width={iconSize} height={iconSize} viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="31" cy="31" r="20" stroke="#b993d6" strokeWidth="2" fill="none" />
    <circle cx="31" cy="31" r="6" fill="#b993d6" />
  </svg>
);
const SkillsIcon = (
  <svg width={iconSize} height={iconSize} viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="16" y="16" width="30" height="30" rx="4" stroke="#b993d6" strokeWidth="2" fill="none" />
  </svg>
);
const OthersIcon = (
  <svg width={iconSize} height={iconSize} viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const AgentIcon = (
  <svg width={iconSize} height={iconSize} viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="31" cy="25" r="8" stroke="#b993d6" strokeWidth="2" fill="none" />
    <path d="M15 45 C15 35 23 30 31 30 C39 30 47 35 47 45" stroke="#b993d6" strokeWidth="2" fill="none" />
    <circle cx="26" cy="22" r="2" fill="#b993d6" />
    <circle cx="36" cy="22" r="2" fill="#b993d6" />
    <path d="M28 28 Q31 30 34 28" stroke="#b993d6" strokeWidth="1.5" fill="none" />
  </svg>
);
const View3DIcon = (
  <svg width={iconSize} height={iconSize} viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 20 L42 20 L42 42 L20 42 Z" stroke="#b993d6" strokeWidth="2" fill="none" />
    <path d="M20 20 L30 12 L50 12 L50 32 L42 20" stroke="#b993d6" strokeWidth="2" fill="none" />
    <path d="M30 12 L30 32 L42 42" stroke="#b993d6" strokeWidth="2" fill="none" />
    <circle cx="31" cy="31" r="3" fill="#b993d6" />
  </svg>
);
const DemoIcon = (
  <svg width={iconSize} height={iconSize} viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="16" y="16" width="30" height="20" rx="2" stroke="#b993d6" strokeWidth="2" fill="none" />
    <rect x="20" y="20" width="22" height="12" rx="1" stroke="#b993d6" strokeWidth="1.5" fill="none" />
    <circle cx="26" cy="26" r="1.5" fill="#b993d6" />
    <circle cx="31" cy="26" r="1.5" fill="#b993d6" />
    <circle cx="36" cy="26" r="1.5" fill="#b993d6" />
    <path d="M20 40 L42 40" stroke="#b993d6" strokeWidth="2" />
    <path d="M25 40 L25 44" stroke="#b993d6" strokeWidth="2" />
    <path d="M31 40 L31 44" stroke="#b993d6" strokeWidth="2" />
    <path d="M37 40 L37 44" stroke="#b993d6" strokeWidth="2" />
  </svg>
);
...
const OpticsIcon = (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <radialGradient id="lensReflection" cx="40%" cy="40%" r="30%">
    ...
    {/* Main circle */}
    <circle cx="24" cy="24" r="20" stroke="#b993d6" strokeWidth="2" fill="none" />
    {/* Tilted diamond/square inside */}
    <path d="M24 12 L32 24 L24 36 L16 24 Z" stroke="#b993d6" strokeWidth="2" fill="none" />
    {/* Lens reflection highlight */}
    <ellipse cx="18" cy="18" rx="4" ry="2" fill="url(#lensReflection)" />
  </svg>
);
...
const PATHsassinDashboard: React.FC = () => {
  ...
  const playClickSound = (frequency: number = 800, duration: number = 0.1) => {
    try {
      initAudio();
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '2.5rem', position: 'relative', zIndex: 10 }}>
        <div
            style={{
            display: 'flex', 
            flexDirection: 'row', 
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', height: '100%' }}>{OpticsIcon}</div>
        ...
        {cards.map((card, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Engraved header (dim until hover/active) */}
              <div style={hovered === i || isActive ? embeddedTextHover : embeddedText}>{card.label}</div>
            </div>
          );
        })}
      </div>
